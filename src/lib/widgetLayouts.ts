...
/**
 * Only used for reading legacy single-array layouts. In the new dual-layout mode, layouts retain their original coordinates and are not rearranged during standard loading.
 */
