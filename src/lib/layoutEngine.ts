...
/**
 * Fixes target at the desired position, shifting intersecting existing widgets
 * downward while preserving their x-coordinates.
 * The limit on movedWidgetIds prevents a single operation from triggering a full layout reflow.
 */
