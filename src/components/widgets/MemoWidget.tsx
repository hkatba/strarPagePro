...
const MemoWidget = ({ widget }: { widget: WidgetOfType<'memo'> }) => {
  ...
  useEffect(() => {
    ...
    // Accept external sync results only when local content still equals the last synced content,
    // avoiding misinterpreting remote updates as "local dirty data" which would stall auto-sync.
